...
The simulator will display email scenarios and ask you to classify each one as:
...
5. The user's score is updated.
6. The process repeats for all email scenarios.
7. A final score and awareness assessment are displayed.
...
* Learning best practices for email security
* Developing safer online habits
...
* GUI using Tkinter
* Email attachment analysis scenarios
* URL inspection exercises
